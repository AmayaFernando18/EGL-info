...
import { Calendar as CalendarIcon, FileText, Zap, ArrowRight, TrendingUp, TrendingDown, ChevronLeft, ChevronRight, Users, Target, Briefcase, Mail, Home, Clock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-base">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Row 1: Latest News + Recent Activity */}
        ...
        {/* Row 2: Calendar + Upcoming Events (parallel height) */}

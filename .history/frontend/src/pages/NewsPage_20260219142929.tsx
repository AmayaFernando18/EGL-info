      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none bg-white text-secondary placeholder-gray-400"
                />
              </div>
              <div className="relative md:w-64">
                ...
                <select
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none appearance-none bg-white text-secondary cursor-pointer"
                >
                  {categories.map(cat => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {regularNews.map((news) => (
            <Card key={news.id} hover className="flex flex-col h-full">
              {news.imageUrl && (
              ...
              <div className="flex flex-col flex-1">
                ...
                <h2 className="text-xl font-bold text-secondary mb-3 hover:text-primary transition-colors line-clamp-2">
                  {news.title}
                </h2>
                <p className="text-gray-600 mb-4 flex-1 line-clamp-3">{news.excerpt}</p>
